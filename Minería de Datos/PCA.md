...
Sea $X \sim (\mu_x, \Sigma)$ con pares de autovalores y autovectores de $\Sigma$ dado por $(\lambda_i, e_i)$ donde  
$$
\lambda_1 \geq \lambda_2 \geq \cdots \geq \lambda_p \geq 0.
$$ 
Entonces, el i-ésimo componente principal es dado por  
$$
Y_i = e_i^T X = e_{i1}X_1 + e_{i2}X_2 + \cdots + e_{ip}X_p, \quad i = 1, 2, \ldots, p
$$  
Se cumple que  
$$
\text{Var}(Y_i) = e_i^T \Sigma e_i = \lambda_i \quad i = 1, 2, \ldots, p
$$  
$$
\text{Cov}(Y_i, Y_k) = e_i^T \Sigma e_k = 0 \quad i \neq k
$$  
Si algunos autovalores son iguales, la selección del autovector correspondiente y CP no son únicos.
