...
# Scheduler
El **scheduler** o programador es un componente del nodo maestro que se encarga de asignar **Pods**  a **Nodes** dentro del clúster. Su principal función es decider dónde se ejecutará cada Pod, basándose en varios criterios.
