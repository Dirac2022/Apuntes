...
la '2\>/dev/null' suprime los mensajes de error.
...
[hydra -l lola -P dict.txt ssh://venus.hackmyvm.eu:5000]{.underline}
...
El siguiente paso es, generar todos los posibles password y guardarlo en un archivo pass.txt
