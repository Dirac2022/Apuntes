...
Precisión: Nos dice cuantos de los casos predichos como positivos resultaron de ser positivos realmente
$$ \text{Precision} = \dfrac{TP}{TP + FP} $$


Recall o  sensibilidad: nos dice de cuántos de los casos positivos reales pudimos predecir correctamente con nuestro modelo
