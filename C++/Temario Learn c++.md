...
- [x] 2.1 Introduction to functions ✅ 2025-09-14
- [x] 2.2 Function return values (value-returning functions) ✅ 2025-09-14
- [x] 2.3 Void functions (non-value returning functions) ✅ 2025-09-14
- [x] 2.4 Introduction to function parameters and arguments ✅ 2025-09-14
- [x] 2.5 Introduction to local scope ✅ 2025-09-18
- [x] 2.6 Why functions are useful, and how to use them effectively ✅ 2025-09-18
- [x] 2.7 Forward declarations and definitions ✅ 2025-09-18
- [x] 2.8 Programs with multiple code files ✅ 2025-09-18
- [x] 2.9 Naming collisions and an introduction to namespaces ✅ 2025-09-18
- [x] 2.10 Introduction to the preprocessor ✅ 2025-09-18
- [x] 2.11 Header files ✅ 2025-09-18
- [x] 2.12 Header guards ✅ 2025-09-18
- [x] 2.13 How to design your first programs ✅ 2025-09-18
...
- [x] 11.6 Function templates ✅ 2025-10-06
- [x] 11.7 Function template instantiation ✅ 2025-10-07
- [x] 11.8 Function templates with multiple template types ✅ 2025-10-07
- [ ] 11.9 Non-type template parameters
- [x] 11.10 Using function templates in multiple files ✅ 2025-10-07
...
- [x] 12.1 Introduction to compound data types ✅ 2025-09-20
- [x] 12.2 Value categories (lvalues and rvalues) ✅ 2025-09-20
- [x] 12.3 Lvalue references ✅ 2025-09-20
- [x] 12.4 Lvalue references to const ✅ 2025-09-30
- [x] 12.5 Pass by lvalue reference ✅ 2025-09-30
- [x] 12.6 Pass by const lvalue reference ✅ 2025-09-30
- [x] 12.7 Introduction to pointers ✅ 2025-09-30
- [x] 12.8 Null pointers ✅ 2025-09-30
- [x] 12.9 Pointers and const ✅ 2025-09-30
- [x] 12.10 Pass by address ✅ 2025-09-30
- [x] 12.11 Pass by address (part 2) ✅ 2025-09-30
...
- [x] 15.9 Friend classes and friend member functions ✅ 2025-10-12
...
## Phase 1: Basic C++ Programming Fundamentals  
This phase covers the basics of syntax, data types, and control structures needed to start programming in C++.

- [x] 1.2 Comments ✅ 2025-09-17
- [x] 2.11 Header files ✅ 2025-09-20
- [x] 2.12 Header guards ✅ 2025-09-20
- [ ] 4.2 Void  
- [ ] 4.4 Signed integers  
- [ ] 4.9 Boolean values  
- [ ] 4.11 Chars  
...
## Phase 2: Functions, Pointers, and Memory Management  
Mastering functions, pointers, and references is crucial for writing robust and efficient C++ code.

- [ ] 7.6 Internal linkage  
- [ ] 7.9 Inline functions and variables  
- [ ] 9.2 Code coverage (optional for testing)  
- [ ] 10.3 Numeric conversions  
- [ ] 11.4 Deleting functions  
- [ ] 11.5 Default arguments  
- [x] 11.6 Function templates ✅ 2025-10-06
...
## Phase 3: Classes, Objects, and Object-Oriented Programming (OOP)  
Start working with object-oriented concepts and generic programming with templates.
...
## Phase 4: Advanced Structures, Dynamic Memory, and Containers  
Get comfortable managing arrays, vectors, and dynamic memory with pointers and destructors.
...
## Phase 5: Advanced C++: Move Semantics, Inheritance, Polymorphism, and Metaprogramming  
Learn advanced resource management, polymorphism, inheritance, and template metaprogramming.
...
## Phase 6: Exception Handling, File I/O, and Practical Topics  
Focus on exception handling and file input/output operations.
...
## Reference and FAQ Resources  
Useful for additional clarification and advanced queries.
...
- [ ] F.X Chapter F summary and quiz  
- [ ] 21.y Chapter 21 project  
- [ ] 27.10 std::move_if_noexcept  (Also in Phase 6, but important to mention)
