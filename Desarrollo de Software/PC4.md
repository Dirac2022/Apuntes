...
* **Enunciado:**
    ...
    * Implementa **Git Hooks** (`pre-commit`) para validar los `Dockerfiles` utilizados.
* **Entregables del Sprint:**
...
* **Enunciado:**
    * Despliega la misma aplicación de ejemplo en un clúster Kubernetes local (Minikube/Kind). ==(**Mitchel**)==
    * Extiende la CLI para que pueda: ==(**Yoel/Mitchel**)==
    ...
    * Desarrolla **pruebas unitarias** (`pytest`) para la lógica de detección de entorno y construcción de comandos. ==(**Mitchel**)==
