...
---
Un "unit test"en Iac es una prueba que verifica el funcionamiento correcto de un modulo de manera aislada. Con ello verificamos la logica interna del modulo en cuenstion sin depender de otros modulos.

---

* Explica cuándo usar mocks o valores fijos (`terraform console`, `terraform output -json`) para testear solo la lógica interna.
---
Justamente cuando creamos "unit-test" creamos mocks, ya que estos simulan una dependencia real. 
