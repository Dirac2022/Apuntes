...
1. **¿Por qué microservicios?**
   ...
   * Describe la evolución histórica desde arquitecturas monolíticas a SOA (Service-Oriented Architecture) y finalmente microservicios.
   * Presenta dos ejemplos de casos de uso (por ejemplo, e-commerce con picos de demanda y aplicación SaaS multi-tenant) donde el monolito se vuelve insostenible.
